...
def network_device_list(dnac, ticket, id=None):
    ...
    """
    url = "https://{}/api/v1/network-device".format(dnac)
    headers["x-auth-token"] = ticket
...
def interface_details(dnac, ticket, id):
    ...
    """
    url = "https://{}/api/v1/interface/{}".format(dnac, id)
    headers["x-auth-token"] = ticket
...
def print_network_device_details(network_device):
    ...
    Input Paramters are:
      network_device: dict object of a network device returned from DNA Center
    Standard Output Details:
...
def print_interface_details(interface):
    ...
    Input Paramters are:
      interface: dictionary object of an interface returned from DNA Center
    Standard Output Details:
      Port Name - (portName)
...
def run_flow_analysis(dnac, ticket, source_ip, destination_ip):
    ...
    """
    base_url = "https://{}/api/v1/flow-analysis".format(dnac)
    headers["x-auth-token"] = ticket
...
def print_flow_analysis_details(flow_analysis):
    ...
    Input Parameters are:
      flow_analysis: dictionary object of a flow analysis returned from DNA Center
    """
...
if __name__ == '__main__':
    ...
    # Retrieve and Print Source Device Details from DNA Center
